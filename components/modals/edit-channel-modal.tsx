...
export const EditChannelModal = () => {
  ...
  const form = useForm({
    ...
    defaultValues: {
      name: "",
      type: channel?.type || ChannelType.TEXT, // Default channel type, fallback to TEXT if no channelType is provided
    },
  });
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      await axios.patch(url, values); // Make a Patch request to edit a existing channel
